...
The internal hostname `tandoor` is the default Docker service name for the Tandoor add-on. If your Tandoor add-on uses a different name, update `nginx.conf` accordingly.
